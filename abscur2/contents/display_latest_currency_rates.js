...
// Данные последних парных валютных курсов
...
// Функция для создания таблицы с последними курсами
function createCurrencyRatesTable() {
    ...
    tableHTML += '<tr><th style="text-align: center;">Тикер валютной пары</th><th style="text-align: right;">11.01.2025</th></tr>';

    for (const [pair, rate] of Object.entries(latestCurrencyRates)) {
        tableHTML += `<tr>
            <td style="text-align: center; border: 1px solid black;">
                <a href="https://www.abscur.ru/p/blog-page_54.html?pair=${pair}" style="text-decoration: none;">${pair}</a>
            </td>
            <td style="text-align: right; border: 1px solid black;">${rate}</td>
        </tr>`;
    }
