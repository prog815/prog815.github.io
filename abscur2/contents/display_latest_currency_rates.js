...
function displayCurrencyRates() {
    ...
    let ratesHTML = '<table border="1"><tr><th>Тикер валютной пары</th><th>Курс на 2025-01-11</th></tr>';

    for (const [ticker, rate] of Object.entries(currencyRates)) {
        ratesHTML += `<tr><td><a href="https://www.abscur.ru/p/blog-page_54.html?pair=${ticker}">${ticker}</a></td><td style="text-align: right;">${rate}</td></tr>`;
    }
